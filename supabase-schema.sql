...
DROP POLICY IF EXISTS "Permitir inserción productos" ON productos;
DROP POLICY IF EXISTS "Permitir actualización productos" ON productos;
DROP POLICY IF EXISTS "Permitir eliminación productos" ON productos;
...
DROP POLICY IF EXISTS "Permitir lectura componentes" ON producto_componentes;
DROP POLICY IF EXISTS "Permitir inserción componentes" ON producto_componentes;
DROP POLICY IF EXISTS "Permitir actualización componentes" ON producto_componentes;
DROP POLICY IF EXISTS "Permitir eliminación componentes" ON producto_componentes;
...
DROP POLICY IF EXISTS "Permitir inserción registros" ON registros;
DROP POLICY IF EXISTS "Permitir actualización registros" ON registros;
DROP POLICY IF EXISTS "Permitir eliminación registros" ON registros;
...
DROP POLICY IF EXISTS "Permitir lectura trazabilidad" ON trazabilidad;
DROP POLICY IF EXISTS "Permitir inserción trazabilidad" ON trazabilidad;
DROP POLICY IF EXISTS "Permitir actualización trazabilidad" ON trazabilidad;
DROP POLICY IF EXISTS "Permitir eliminación trazabilidad" ON trazabilidad;
...
DROP POLICY IF EXISTS "Permitir lectura board_fotos" ON board_fotos;
DROP POLICY IF EXISTS "Permitir inserción board_fotos" ON board_fotos;
DROP POLICY IF EXISTS "Permitir actualización board_fotos" ON board_fotos;
DROP POLICY IF EXISTS "Permitir eliminación board_fotos" ON board_fotos;
